...
if __name__ == '__main__':  
    ...
    parser.add_argument('--plvec', type=str, default='/home/alex/Documents/nlp/code/data')
    parser.add_argument('--train', type=str, default='/home/alex/Documents/nlp/code/data/fb_training_twitter_small.txt')
    parser.add_argument('--dev', type=str, default='/home/alex/Documents/nlp/code/data/fb_dev_twitter_small.txt')
    parser.add_argument('--test', type=str, default='/home/alex/Documents/nlp/code/data/fb_test_twitter.txt')

...
def exe(word_vectors_file, vector_preloaded_path, train_path, dev_path, test_path, hidden_sizes, maxlen, pep, fep):
    ...
    lstm = Model(word_vectors, hidden_sizes=hidden_sizes, epochs=pep)
...
exe(args.vectors, args.plvec, args.train, args.dev, args.test, args.hs, args.max, args.pep, args.fep)